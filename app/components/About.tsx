  ...
  return (
    <section id='about' className='py-20 px-6 md:px-12 lg:px-24 bg-white'>
      <div className='max-w-5xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10'>
        ...
        >
          <h2 className='relative text-3xl sm:text-4xl font-bold text-gray-800 dark:text-red-400 inline-block'>
            About Me
        ...
        >
          <div className='relative w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 rounded-full overflow-hidden shadow-lg flex items-center justify-center'>
            <Image
              src='/prf.png'
              alt='Chandrika'
              width={400}
